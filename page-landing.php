                    ...
                    <div class="col-12 col-lg-10">
                        <div class="box">
                            <div class="mbr-media show-modal align-center" data-modal=".modalWindow">
                                <a href="http://jagokeuangan.com/wp-content/uploads/2021/05/Video-1-1.m4v"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/mbr.jpg" alt="Mobirise" /></a>
                                <div class="icon-wrap">
                                    <a class="text-primary" href="#"><span class="mbr-iconfont socicon-youtube socicon" style="color: rgb(228, 63, 63); fill: rgb(228, 63, 63);"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modalWindow" style="display: none;">
                    <div class="modalWindow-container">
                        <div class="modalWindow-video-container">
                            <div class="modalWindow-video"><iframe width="100%" height="100%" frameborder="0" allowfullscreen="1" data-src="https://www.youtube.com/watch?v=VA8PzkQa8d8"></iframe></div>
                            <a class="close" role="button" data-dismiss="modal"> <span aria-hidden="true" class="mbr-iconfont mobi-mbri-close mobi-mbri closeModal"></span> <span class="sr-only">Close</span> </a>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <section class="features5 cid-swsdcSa2ai" id="features6-9">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="card col-12 col-lg-6">
                        <div class="card-wrapper mbr-flex">
                            <div class="card-box align-left">
                                <h5 class="card-title mbr-fonts-style align-left mb-3 display-5"><strong>Video 1</strong></h5>
                                <p class="mbr-text mbr-fonts-style mb-3 display-4">Deskripsi video yang akan diputar</p>
                            ...
                            <div class="img-wrapper img1 align-center"><span class="mbr-iconfont mbrib-video"></span></div>
                        </div>
                    </div>
                    <div class="card col-12 col-lg-6">
                        <div class="card-wrapper mbr-flex">
                            <div class="card-box align-left">
                                <h5 class="card-title mbr-fonts-style align-left mb-3 display-5"><strong>Video 2</strong></h5>
                                <p class="mbr-text mbr-fonts-style mb-3 display-4">Deskripsi video yang akan diputar</p>
                            ...
                            <div class="img-wrapper img2 align-center"><span class="mbr-iconfont mbrib-video"></span></div>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <section class="features5 cid-swsddpOj0D" id="features6-a">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="card col-12 col-lg-6">
                        <div class="card-wrapper mbr-flex">
                            <div class="card-box align-left">
                                <h5 class="card-title mbr-fonts-style align-left mb-3 display-5"><strong>Video 3</strong></h5>
                                <p class="mbr-text mbr-fonts-style mb-3 display-4">Deskripsi video yang akan diputar</p>
                    ...
                    <div class="card col-12 col-lg-6">
                        <div class="card-wrapper mbr-flex">
                            <div class="card-box align-left">
                                <h5 class="card-title mbr-fonts-style align-left mb-3 display-5"><strong>Video 4</strong></h5>
                                <p class="mbr-text mbr-fonts-style mb-3 display-4">Deskripsi video yang akan diputar</p>
